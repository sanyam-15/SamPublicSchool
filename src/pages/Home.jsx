          ...
          <div className="z-10 absolute -bottom-12 left-0 right-0">
            <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              >
                ...
                <h3 className="text-xl font-bold text-gray-900 dark:text-gold-100 mb-3">
                  Academic Excellence
                </h3>
                <p className="text-gray-600 dark:text-gray-300">
                  Comprehensive curriculum fostering holistic development and
              ...
              >
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  Diverse range of extracurricular programs for all-round
                  development
                </p>
              </motion.div>
